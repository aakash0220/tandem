        ...
        <div className="bg-dark text-secondary px-4 py-5 text-center ">
            <div className="py-5 ">
                ...
                <div className="col-lg-6 mx-auto">
                    <p className="fs-5 mb-4">This site demonstates the working of GPS data processing into a map visualization using react-leaflet and made as a part of intern hiring for Tandem at the National Institute of Technology Karnataka, Surathkal</p>
